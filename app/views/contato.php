...
<head>
    ...
    <!-- SLICK -->
    <link rel="stylesheet" href="http://localhost/KiOficinale/public/assets/css/slick.css">
    <link rel="stylesheet" href="http://localhost/KiOficinale/public/assets/css/slick-theme.css">

    <!-- LITY -->
    <link rel="stylesheet" href="http://localhost/KiOficinale/public/assets/css/lity.css">
    <link rel="stylesheet" href="http://localhost/KiOficinale/public/assets/css/estilo.css">

    <!-- ESTILO DO TEMPLATE --> <!-- ESTILO DO TEMPLATE --> <!-- ESTILO DO TEMPLATE --> <!-- ESTILO DO TEMPLATE --> <!-- ESTILO DO TEMPLATE --> <!-- ESTILO DO TEMPLATE -->

    <link rel="icon" href="http://localhost/KiOficinale/public/assets/img/favicon.svg" />
    <!-- Site Title -->
    <title>Car Repair & Auto Services</title>
    
    <link rel="stylesheet" href="http://localhost/KiOficinale/public/assets/css/plugins/lightgallery.min.css" />
    <link rel="stylesheet" href="http://localhost/KiOficinale/public/assets/css/plugins/swiper.min.css" />
    <link rel="stylesheet" href="http://localhost/KiOficinale/public/assets/css/plugins/aos.css" />
    <link rel="stylesheet" href="http://localhost/KiOficinale/public/assets/css/plugins/bootstrap.min.css" />
    <link rel="stylesheet" href="http://localhost/KiOficinale/public/assets/css/style.css" />
...
<body>
    ...
    <div class="container">
        <div class="contact-content">
            <div class="contact-title-section" data-aos="fade-up" data-aos-delay="700">
                <h2 class="contact-form-title ak-white-color text-uppercase">Contact Us</h2>
                <p>Home / Contact</p>
            </div>
                ...
                <form method="POST" action="contato/enviarEmail">
                    ...
                    <div class="from-textarea">
                        <div class="type_1">
                            ...
                            <textarea name="mensagem" rows="5" id="mensagem" required></textarea>
                        </div>
                    </div>
                    <!-- <div class="custom-file">
                        <label class="custom-file-upload" for="file">+ <span>Add Attachment</span></label>
                        <input type="file" id="file" name="attachment" accept=".pdf, .doc, .docx">
                    </div> -->
                    <div class="ak-height-40 ak-height-lg-20"></div>
                    <input type="submit" value="Enviar Mensgem" class="common-btn">
                </form>
            </div>
        </div>
    </div>
            ...
            <div class="left-info" data-aos="fade-right">
                <div class="content">
                    <div class="ak-section-heading ak-style-1">
                        ...
                        <p class="ak-section-subtitle">There are many variations of passages of Lorem Ipsum
                            available,
    ...
    <!-- SLICK -->
    <script src="http://localhost/KiOficinale/public/assets/js/slick.js"></script>

    <!-- LITY -->
    <script src="http://localhost/KiOficinale/public/assets/js/lity.min.js"></script>


    <script src="http://localhost/KiOficinale/public/assets/js/oficina.js"></script>

    <script src="https://code.jquery.com/jquery-3.6.0.min.js"></script> 
    <script src="http://localhost/KiOficinale/public/assets/js/plugins/lightgallery.min.js"></script>
    <script src="http://localhost/KiOficinale/public/assets/js/plugins/simplePagination.min.js"></script>
    <script src="http://localhost/KiOficinale/public/assets/js/plugins/aos.js"></script>
    <script src="http://localhost/KiOficinale/public/assets/js/plugins/swiper.min.js"></script>
    <script src="http://localhost/KiOficinale/public/assets/js/plugins/SplitText.min.js"></script>
    <script src="http://localhost/KiOficinale/public/assets/js/main.js"></script>
