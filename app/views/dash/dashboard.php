<!-- <h1>Bem-Vindo Meu benevolente <?php echo $nomeUser; ?> </h1>
<h2><?php echo $_SESSION['userId']; ?></h2>
<h2><?php echo $_SESSION['userTipo']; ?></h2> -->

<!-- <a href="http://localhost/KiOficinale/public/auth/sair">SAIR</a>  -->
...
<head>
    ...
    <link rel="stylesheet" href="http://localhost/KiOficinale/public/vendors/dash/css/adminlte.css"><!--end::Required Plugin(AdminLTE)--><!-- apexcharts -->
...
<body class="layout-fixed sidebar-expand-lg bg-body-tertiary">
        ...
        <nav class="app-header navbar navbar-expand bg-body"> <!--begin::Container-->
            ...
            <div class="container-fluid"> <!--begin::Start Navbar Links-->
                ...
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item d-none d-md-block"> <a href="#" class="nav-link">Site KiOficina</a> </li>
                ...
                <ul class="navbar-nav ms-auto"> <!--begin::Navbar Search-->
                    ...
                    <li class="nav-item dropdown"> <a class="nav-link" data-bs-toggle="dropdown" href="#"> <i class="bi bi-chat-text"></i> <span class="navbar-badge badge text-bg-danger">3</span> </a>
                        <div class="dropdown-menu dropdown-menu-lg dropdown-menu-end"> <a href="#" class="dropdown-item"> <!--begin::Message-->
                                <div class="d-flex">
                                    <div class="flex-shrink-0"> <img src="http://localhost/KiOficinale/public/vendors/dash/assets/img/user1-128x128.jpg" alt="User Avatar" class="img-size-50 rounded-circle me-3"> </div>
                            ...
                            <div class="dropdown-divider"></div> <a href="#" class="dropdown-item"> <!--begin::Message-->
                                <div class="d-flex">
                                    <div class="flex-shrink-0"> <img src="http://localhost/KiOficinale/public/vendors/dash/assets/img/user8-128x128.jpg" alt="User Avatar" class="img-size-50 rounded-circle me-3"> </div>
                                    <div class="flex-grow-1">
                                        <h3 class="dropdown-item-title">
                                            John Pierce
                            ...
                            <div class="dropdown-divider"></div> <a href="#" class="dropdown-item"> <!--begin::Message-->
                                <div class="d-flex">
                                    <div class="flex-shrink-0"> <img src="http://localhost/KiOficinale/public/vendors/dash/assets/img/user3-128x128.jpg" alt="User Avatar" class="img-size-50 rounded-circle me-3"> </div>
                                    <div class="flex-grow-1">
                                        <h3 class="dropdown-item-title">
                                            Nora Silvester
                    ...
                    <li class="nav-item dropdown user-menu"> <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown"> <img src="http://localhost/KiOficinale/public/assets/img/sergio.jpg" class="user-image rounded-circle shadow" alt="User Image"> <span class="d-none d-md-inline">Henryque Nonato</span> </a>
                        <ul class="dropdown-menu dropdown-menu-lg dropdown-menu-end"> <!--begin::User Image-->
                            <li class="user-header text-bg-primary"> <img src="http://localhost/KiOficinale/public/assets/img/sergio.jpg" class="rounded-circle shadow" alt="User Image">
                                <p>
                                    Henryque Nonato - Web Developer
                            ...
                            <li class="user-footer"> <a href="#" class="btn btn-default btn-flat">Profile</a> <a href="http://localhost/KiOficinale/public/auth/sair" class="btn btn-default btn-flat float-end">Sair</a> </li> <!--end::Menu Footer-->
                        </ul>
            ...
            <div class=" sidebar-wrapper">
                <nav class="mt-2"> <!--begin::Sidebar Menu-->
                    <ul class="nav sidebar-menu flex-column" data-lte-toggle="treeview" role="menu" data-accordion="false">
                        ...
                        <li class="nav-item"> <a href="#" class="nav-link"> <i class="bi bi-suitcase-lg-fill"></i>
                                <p>
                                    Recursos Humanos
    ...
    <script src="http://localhost/KiOficinale/public/vendors/dash/js/adminlte.js"></script> <!--end::Required Plugin(AdminLTE)--><!--begin::OverlayScrollbars Configure-->
    <script>
